...
interface SocialViewProps {
  socialType: "INSTAGRAM" | "TWITTER" | "TIKTOK" | "LINKEDIN";
  setView: (view: View) => void;
}

const socialLinks: Record<"INSTAGRAM" | "TWITTER" | "TIKTOK" | "LINKEDIN", { url: string; label: string }> = {
  INSTAGRAM: { url: "https://www.instagram.com/ggmachines", label: "Instagram" },
  TWITTER: { url: "https://twitter.com/ggmachines", label: "Twitter" },
  TIKTOK: { url: "https://www.tiktok.com/@ggmachines", label: "TikTok" },
  LINKEDIN: { url: "https://www.linkedin.com/company/ggmachines", label: "LinkedIn" },
};

const SocialView: React.FC<SocialViewProps> = ({ socialType, setView }) => {
  const social = socialLinks[socialType];
